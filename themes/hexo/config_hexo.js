const CONFIG_HEXO = {
  ...
  HOME_BANNER_GREETINGS: ['Hi，我是一个需求分析师', 'Hi，我是一个折腾能手', 'Hi，我是一个业余摄影师', '欢迎来到我的博客🎉'], // 首页大图标语文字

  HOME_NAV_BUTTONS: true, // 首页是否显示分类大图标按钮
  HOME_NAV_BACKGROUND_IMG_FIXED: false, // 首页背景图滚动时是否固定，true 则滚动时图片不动； false则随鼠标滚动
