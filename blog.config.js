...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wilson Zeng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '年轻是事实，不被看轻需要证实', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wilsonzeng.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hfoi589@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/hfoi589', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号是不存在的', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_UTTERRANCES_REPO:
      process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'hfoi589/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'hfoi589/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
